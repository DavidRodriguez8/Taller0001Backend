...
const suma = (op1, op2) => `El valor de la suma es ${op1 + op2}`
...
const { instagram:insta, facebook } = web.redesSociales
console.log(insta)
...
const [ manzana, ...misFrutas ] = frutas
const misPostres = [...misFrutas, ...dulces]
console.log(misPostres)*/
